  ...
  <div class="main-container">
    ...
    {#if isAuthenticated}
      ...
      {#if showForm}
        ...
        <BookManager
          on:bookUpdated={(e) => {
            if (bookToEdit) handleBookUpdated(e);
            else handleBookSaved(e);
          }}
        />
      {:else if bookToEdit}
        <BookManager
        ...
        <div class="book-grid">
          {#each books as book (book.id)}
            <div
              ...
              tabindex="0"
              on:keydown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') toggleFlip(book.id);
              }}
            >
              <div class="flipper">
                <div class="front">
        ...
        {#if showRegistration}
          ...
          <p class="small-link">
            ...
            <button
              type="button"
              class="linklike"
              on:click={() => (showRegistration = false)}
            >
              Log In
            </button>
          </p>
        {:else}
          ...
          <p class="small-link">
            ...
            <button
              type="button"
              class="linklike"
              on:click={() => (showRegistration = true)}
            >
              Register Here
            </button>
          </p>
...
<style>
  ...
  /* ✅ Center content + ensure multi-line titles center properly */
  .front {
